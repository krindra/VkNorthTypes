...
1. - [ ] Edit [`groupId` and `version`](convention-plugins/src/main/kotlin/module.publication.gradle.kts#L10-L11)
    1. If you need the Android support update namespace [there](VkNorthTypes/build.gradle.kts#L38) too
    1. If you don't need an Android support delete the [`android` section](VkNorthTypes/build.gradle.kts#L37-L43)
1. - [ ] Edit [build targets you need](VkNorthTypes/build.gradle.kts#L9-L21)
