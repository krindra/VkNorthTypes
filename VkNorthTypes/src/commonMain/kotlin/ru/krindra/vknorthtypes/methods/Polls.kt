...
class Polls(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetvotersResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(PollsGetVotersResponse.serializer(), PollsGetVotersFieldsResponse.serializer())
        ...
        fun PollsGetVotersResponse(): PollsGetVotersResponse?{
            return if (response is PollsGetVotersResponse) response else null
        }
        fun PollsGetVotersFieldsResponse(): PollsGetVotersFieldsResponse?{
            return if (response is PollsGetVotersFieldsResponse) response else null
        }
    }
