...
class Users(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetfollowersResponse(
        ...
        fun UsersGetFollowersFieldsResponse(): UsersGetFollowersFieldsResponse? {
            return try {
                getResponse(UsersGetFollowersFieldsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun UsersGetFollowersResponse(): UsersGetFollowersResponse? {
            return try {
                getResponse(UsersGetFollowersResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetsubscriptionsResponse(
        ...
        fun UsersGetSubscriptionsResponse(): UsersGetSubscriptionsResponse? {
            return try {
                getResponse(UsersGetSubscriptionsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun UsersGetSubscriptionsExtendedResponse(): UsersGetSubscriptionsExtendedResponse? {
            return try {
                getResponse(UsersGetSubscriptionsExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
