...
class Friends(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class ArefriendsResponse(
        ...
        fun FriendsAreFriendsExtendedResponse(): FriendsAreFriendsExtendedResponse? {
            return try {
                getResponse(FriendsAreFriendsExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun FriendsAreFriendsResponse(): FriendsAreFriendsResponse? {
            return try {
                getResponse(FriendsAreFriendsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetResponse(
        ...
        fun FriendsGetFieldsResponse(): FriendsGetFieldsResponse? {
            return try {
                getResponse(FriendsGetFieldsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun FriendsGetResponse(): FriendsGetResponse? {
            return try {
                getResponse(FriendsGetResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetmutualResponse(
        ...
        fun FriendsGetMutualTargetUidsResponse(): FriendsGetMutualTargetUidsResponse? {
            return try {
                getResponse(FriendsGetMutualTargetUidsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun FriendsGetMutualResponse(): FriendsGetMutualResponse? {
            return try {
                getResponse(FriendsGetMutualResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetonlineResponse(
        ...
        fun FriendsGetOnlineResponse(): FriendsGetOnlineResponse? {
            return try {
                getResponse(FriendsGetOnlineResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun FriendsGetOnlineOnlineMobileResponse(): FriendsGetOnlineOnlineMobileResponse? {
            return try {
                getResponse(FriendsGetOnlineOnlineMobileResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetrequestsResponse(
        ...
        fun FriendsGetRequestsNeedMutualResponse(): FriendsGetRequestsNeedMutualResponse? {
            return try {
                getResponse(FriendsGetRequestsNeedMutualResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun FriendsGetRequestsResponse(): FriendsGetRequestsResponse? {
            return try {
                getResponse(FriendsGetRequestsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun FriendsGetRequestsExtendedResponse(): FriendsGetRequestsExtendedResponse? {
            return try {
                getResponse(FriendsGetRequestsExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
