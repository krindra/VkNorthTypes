...
class Board(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetcommentsResponse(private val rawResponse: String, json: Json):
        ...
        private val responsesSerializers = listOf(BoardGetCommentsExtendedResponse.serializer(), BoardGetCommentsResponse.serializer())
        ...
        fun BoardGetCommentsExtendedResponse(): BoardGetCommentsExtendedResponse?{
            return if (response is BoardGetCommentsExtendedResponse) response else null
        }
        fun BoardGetCommentsResponse(): BoardGetCommentsResponse?{
            return if (response is BoardGetCommentsResponse) response else null
        }
    }
    ...
    class GettopicsResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(BoardGetTopicsResponse.serializer(), BoardGetTopicsExtendedResponse.serializer())
        ...
        fun BoardGetTopicsResponse(): BoardGetTopicsResponse?{
            return if (response is BoardGetTopicsResponse) response else null
        }
        fun BoardGetTopicsExtendedResponse(): BoardGetTopicsExtendedResponse?{
            return if (response is BoardGetTopicsExtendedResponse) response else null
        }
    }
