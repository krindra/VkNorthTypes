...
class Video(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class AddtoalbumResponse(
        ...
        fun VideoChangeVideoAlbumsResponse(): VideoChangeVideoAlbumsResponse? {
            return try {
                getResponse(VideoChangeVideoAlbumsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetalbumsResponse(
        ...
        fun VideoGetAlbumsExtendedResponse(): VideoGetAlbumsExtendedResponse? {
            return try {
                getResponse(VideoGetAlbumsExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun VideoGetAlbumsResponse(): VideoGetAlbumsResponse? {
            return try {
                getResponse(VideoGetAlbumsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetalbumsbyvideoResponse(
        ...
        fun VideoGetAlbumsByVideoExtendedResponse(): VideoGetAlbumsByVideoExtendedResponse? {
            return try {
                getResponse(VideoGetAlbumsByVideoExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun VideoGetAlbumsByVideoResponse(): VideoGetAlbumsByVideoResponse? {
            return try {
                getResponse(VideoGetAlbumsByVideoResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetcommentsResponse(
        ...
        fun VideoGetCommentsExtendedResponse(): VideoGetCommentsExtendedResponse? {
            return try {
                getResponse(VideoGetCommentsExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun VideoGetCommentsResponse(): VideoGetCommentsResponse? {
            return try {
                getResponse(VideoGetCommentsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class SearchResponse(
        ...
        fun VideoSearchResponse(): VideoSearchResponse? {
            return try {
                getResponse(VideoSearchResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun VideoSearchExtendedResponse(): VideoSearchExtendedResponse? {
            return try {
                getResponse(VideoSearchExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
