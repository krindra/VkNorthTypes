...
class Apps(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetfriendslistResponse(
        ...
        fun AppsGetFriendsListExtendedResponse(): AppsGetFriendsListExtendedResponse? {
            return try {
                getResponse(AppsGetFriendsListExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun AppsGetFriendsListResponse(): AppsGetFriendsListResponse? {
            return try {
                getResponse(AppsGetFriendsListResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetleaderboardResponse(
        ...
        fun AppsGetLeaderboardExtendedResponse(): AppsGetLeaderboardExtendedResponse? {
            return try {
                getResponse(AppsGetLeaderboardExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun AppsGetLeaderboardResponse(): AppsGetLeaderboardResponse? {
            return try {
                getResponse(AppsGetLeaderboardResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
