...
class Newsfeed(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetbannedResponse(private val rawResponse: String, json: Json):
        ...
        private val responsesSerializers = listOf(NewsfeedGetBannedResponse.serializer(), NewsfeedGetBannedExtendedResponse.serializer())
        ...
        fun NewsfeedGetBannedResponse(): NewsfeedGetBannedResponse?{
            return if (response is NewsfeedGetBannedResponse) response else null
        }
        fun NewsfeedGetBannedExtendedResponse(): NewsfeedGetBannedExtendedResponse?{
            return if (response is NewsfeedGetBannedExtendedResponse) response else null
        }
    }
    ...
    class GetlistsResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(NewsfeedGetListsResponse.serializer(), NewsfeedGetListsExtendedResponse.serializer())
        ...
        fun NewsfeedGetListsResponse(): NewsfeedGetListsResponse?{
            return if (response is NewsfeedGetListsResponse) response else null
        }
        fun NewsfeedGetListsExtendedResponse(): NewsfeedGetListsExtendedResponse?{
            return if (response is NewsfeedGetListsExtendedResponse) response else null
        }
    }
    ...
    class SearchResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(NewsfeedSearchExtendedResponse.serializer(), NewsfeedSearchStrictResponse.serializer(), NewsfeedSearchResponse.serializer(), NewsfeedSearchExtendedStrictResponse.serializer())
        ...
        fun NewsfeedSearchExtendedResponse(): NewsfeedSearchExtendedResponse?{
            return if (response is NewsfeedSearchExtendedResponse) response else null
        }
        fun NewsfeedSearchStrictResponse(): NewsfeedSearchStrictResponse?{
            return if (response is NewsfeedSearchStrictResponse) response else null
        }
        fun NewsfeedSearchResponse(): NewsfeedSearchResponse?{
            return if (response is NewsfeedSearchResponse) response else null
        }
        fun NewsfeedSearchExtendedStrictResponse(): NewsfeedSearchExtendedStrictResponse?{
            return if (response is NewsfeedSearchExtendedStrictResponse) response else null
        }
    }
