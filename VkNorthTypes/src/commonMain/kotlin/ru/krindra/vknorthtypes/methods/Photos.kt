...
class Photos(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetcommentsResponse(private val rawResponse: String, json: Json):
        ...
        private val responsesSerializers = listOf(PhotosGetCommentsExtendedResponse.serializer(), PhotosGetCommentsResponse.serializer())
        ...
        fun PhotosGetCommentsExtendedResponse(): PhotosGetCommentsExtendedResponse?{
            return if (response is PhotosGetCommentsExtendedResponse) response else null
        }
        fun PhotosGetCommentsResponse(): PhotosGetCommentsResponse?{
            return if (response is PhotosGetCommentsResponse) response else null
        }
    }
