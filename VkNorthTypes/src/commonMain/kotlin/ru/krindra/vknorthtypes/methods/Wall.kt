...
class Wall(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetResponse(
        ...
        fun WallGetResponse(): WallGetResponse? {
            return try {
                getResponse(WallGetResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun WallGetExtendedResponse(): WallGetExtendedResponse? {
            return try {
                getResponse(WallGetExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetbyidResponse(
        ...
        fun WallGetByIdResponse(): WallGetByIdResponse? {
            return try {
                getResponse(WallGetByIdResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun WallGetByIdExtendedResponse(): WallGetByIdExtendedResponse? {
            return try {
                getResponse(WallGetByIdExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetcommentResponse(
        ...
        fun WallGetCommentResponse(): WallGetCommentResponse? {
            return try {
                getResponse(WallGetCommentResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun WallGetCommentExtendedResponse(): WallGetCommentExtendedResponse? {
            return try {
                getResponse(WallGetCommentExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class GetcommentsResponse(
        ...
        fun WallGetCommentsResponse(): WallGetCommentsResponse? {
            return try {
                getResponse(WallGetCommentsResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun WallGetCommentsExtendedResponse(): WallGetCommentsExtendedResponse? {
            return try {
                getResponse(WallGetCommentsExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
    ...
    class SearchResponse(
        ...
        fun WallSearchResponse(): WallSearchResponse? {
            return try {
                getResponse(WallSearchResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
        fun WallSearchExtendedResponse(): WallSearchExtendedResponse? {
            return try {
                getResponse(WallSearchExtendedResponse.serializer(), rawResponse)
            } catch(e: Exception) { null }
        }
    }
