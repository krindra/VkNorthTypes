...
class Groups(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetResponse(private val rawResponse: String, json: Json):
        ...
        private val responsesSerializers = listOf(GroupsGetResponse.serializer(), GroupsGetObjectExtendedResponse.serializer())
        ...
        fun GroupsGetResponse(): GroupsGetResponse?{
            return if (response is GroupsGetResponse) response else null
        }
        fun GroupsGetObjectExtendedResponse(): GroupsGetObjectExtendedResponse?{
            return if (response is GroupsGetObjectExtendedResponse) response else null
        }
    }
    ...
    class GetcataloginfoResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(GroupsGetCatalogInfoExtendedResponse.serializer(), GroupsGetCatalogInfoResponse.serializer())
        ...
        fun GroupsGetCatalogInfoExtendedResponse(): GroupsGetCatalogInfoExtendedResponse?{
            return if (response is GroupsGetCatalogInfoExtendedResponse) response else null
        }
        fun GroupsGetCatalogInfoResponse(): GroupsGetCatalogInfoResponse?{
            return if (response is GroupsGetCatalogInfoResponse) response else null
        }
    }
    ...
    class GetinvitesResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(GroupsGetInvitesResponse.serializer(), GroupsGetInvitesExtendedResponse.serializer())
        ...
        fun GroupsGetInvitesResponse(): GroupsGetInvitesResponse?{
            return if (response is GroupsGetInvitesResponse) response else null
        }
        fun GroupsGetInvitesExtendedResponse(): GroupsGetInvitesExtendedResponse?{
            return if (response is GroupsGetInvitesExtendedResponse) response else null
        }
    }
    ...
    class GetmembersResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(GroupsGetMembersResponse.serializer(), GroupsGetMembersFilterResponse.serializer(), GroupsGetMembersFieldsResponse.serializer())
        ...
        fun GroupsGetMembersResponse(): GroupsGetMembersResponse?{
            return if (response is GroupsGetMembersResponse) response else null
        }
        fun GroupsGetMembersFilterResponse(): GroupsGetMembersFilterResponse?{
            return if (response is GroupsGetMembersFilterResponse) response else null
        }
        fun GroupsGetMembersFieldsResponse(): GroupsGetMembersFieldsResponse?{
            return if (response is GroupsGetMembersFieldsResponse) response else null
        }
    }
    ...
    class GetrequestsResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(GroupsGetRequestsFieldsResponse.serializer(), GroupsGetRequestsResponse.serializer())
        ...
        fun GroupsGetRequestsFieldsResponse(): GroupsGetRequestsFieldsResponse?{
            return if (response is GroupsGetRequestsFieldsResponse) response else null
        }
        fun GroupsGetRequestsResponse(): GroupsGetRequestsResponse?{
            return if (response is GroupsGetRequestsResponse) response else null
        }
    }
    ...
    class InviteResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(GroupsInviteUserIdsListResponse.serializer(), BaseOkResponse.serializer())
        ...
        fun GroupsInviteUserIdsListResponse(): GroupsInviteUserIdsListResponse?{
            return if (response is GroupsInviteUserIdsListResponse) response else null
        }
    ...
    class IsmemberResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(BaseBoolResponse.serializer(), GroupsIsMemberExtendedResponse.serializer(), GroupsIsMemberUserIdsResponse.serializer(), GroupsIsMemberUserIdsExtendedResponse.serializer())
        ...
        fun BaseBoolResponse(): BaseBoolResponse?{
            return if (response is BaseBoolResponse) response else null
        }
        fun GroupsIsMemberExtendedResponse(): GroupsIsMemberExtendedResponse?{
            return if (response is GroupsIsMemberExtendedResponse) response else null
        }
        fun GroupsIsMemberUserIdsResponse(): GroupsIsMemberUserIdsResponse?{
            return if (response is GroupsIsMemberUserIdsResponse) response else null
        }
        fun GroupsIsMemberUserIdsExtendedResponse(): GroupsIsMemberUserIdsExtendedResponse?{
            return if (response is GroupsIsMemberUserIdsExtendedResponse) response else null
        }
    }
