...
class Stories(private val method: suspend (String, Map<Any, Any?>) -> String, private val json: Json) {
    ...
    class GetbannedResponse(private val rawResponse: String, json: Json):
        BaseMultivariateResponse(json) {
        private val response: Any = response()
        private val responsesSerializers = listOf(StoriesGetBannedExtendedResponse.serializer(), StoriesGetBannedResponse.serializer())
        ...
        fun StoriesGetBannedExtendedResponse(): StoriesGetBannedExtendedResponse?{
            return if (response is StoriesGetBannedExtendedResponse) response else null
        }
        fun StoriesGetBannedResponse(): StoriesGetBannedResponse?{
            return if (response is StoriesGetBannedResponse) response else null
        }
    }
