...
data class VideoVideoFull (
    ...
    @SerialName("files") val files: VideoVideoFiles? = null,
    ...
    @SerialName("episodes") val episodes: List<VideoEpisode>? = null,
    ...
    @SerialName("trailer") val trailer: VideoVideoFiles? = null,
    @SerialName("can_delete") val canDelete: BaseBoolInt? = null,
    @SerialName("comments") val comments: Int? = null,
    @SerialName("user_id") val userId: Long? = null,
    @SerialName("live_settings") val liveSettings: VideoLiveSettings? = null,
)
