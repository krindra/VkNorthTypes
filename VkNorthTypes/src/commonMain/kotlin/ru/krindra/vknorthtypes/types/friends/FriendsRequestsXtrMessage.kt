...
/**
 *
 * @param message Message sent with a request
 * @param id User ID
 * @param userId User ID
 * @param from_ ID of the user by whom friend has been suggested
 * @param mutual 
 * @param trackCode 
 ...
 */
@Serializable
data class FriendsRequestsXtrMessage (
    ...
    @SerialName("from_") val from_: String? = null,
